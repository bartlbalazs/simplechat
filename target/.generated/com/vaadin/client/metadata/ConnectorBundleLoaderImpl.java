...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.MenuBar","com.vaadin.ui.UI","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.VerticalLayout","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Accordion","com.vaadin.ui.OptionGroup","com.vaadin.ui.Upload","com.vaadin.ui.ComboBox","com.vaadin.ui.Tree","com.vaadin.ui.Slider","com.vaadin.ui.TreeTable","com.vaadin.ui.PopupView","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.FormLayout","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.TabSheet","com.vaadin.ui.GridLayout","com.vaadin.ui.Image","com.vaadin.ui.Audio","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.BrowserFrame","com.vaadin.ui.CssLayout","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.CustomField","com.vaadin.ui.NativeSelect","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.Label","com.vaadin.ui.ListSelect","com.vaadin.ui.Window","com.vaadin.ui.JavaScript","com.vaadin.ui.CustomComponent","com.vaadin.ui.ProgressBar","com.vaadin.ui.NativeButton","com.vaadin.ui.CheckBox","com.vaadin.ui.Flash","com.vaadin.server.FileDownloader","com.vaadin.ui.Video","com.vaadin.ui.TextField","com.vaadin.ui.TextArea","com.vaadin.ui.Embedded","com.vaadin.ui.Button","com.vaadin.ui.CustomLayout","com.vaadin.ui.Link","com.vaadin.ui.Form","com.vaadin.ui.DateField","com.vaadin.ui.InlineDateField","com.vaadin.ui.PasswordField","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.Table","com.vaadin.ui.Panel",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"marginsBitmask", "height", "resources", "description", "styles", "caption", "primaryStyleName", "registeredEventListeners", "readOnly", "id", "errorMessage", "immediate", "width", "childData", "spacing", "enabled", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"readOnly", "maxValue", "resolution", "errorMessage", "styles", "orientation", "caption", "immediate", "hideErrors", "description", "value", "registeredEventListeners", "width", "required", "propertyReadOnly", "tabIndex", "minValue", "enabled", "resources", "height", "primaryStyleName", "id", "modified", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"openDelay", "quickOpenDelay", "maxWidth", "quickOpenTimeout", "closeTimeout", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"description", "errorMessage", "width", "caption", "height", "readOnly", "templateContents", "primaryStyleName", "childLocations", "immediate", "registeredEventListeners", "styles", "enabled", "resources", "templateName", "id", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"mode", "parameters", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"registeredEventListeners", "resources", "enabled", "callbackNames", "rpcInterfaces", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"state", "errorMessage", "primaryStyleName", "indeterminate", "description", "modified", "id", "styles", "caption", "resources", "hideErrors", "required", "propertyReadOnly", "tabIndex", "width", "height", "enabled", "registeredEventListeners", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"description", "caption", "registeredEventListeners", "immediate", "primaryStyleName", "width", "id", "resources", "errorMessage", "enabled", "alternateText", "height", "readOnly", "styles", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"id", "width", "styles", "caption", "errorMessage", "registeredEventListeners", "readOnly", "enabled", "description", "primaryStyleName", "height", "resources", "childCss", "immediate", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"tabIndex", "readOnly", "immediate", "enabled", "iconAltText", "description", "styles", "id", "caption", "errorMessage", "width", "disableOnClick", "height", "resources", "primaryStyleName", "registeredEventListeners", "htmlContentAllowed", "clickShortcutKeyCode", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"height", "features", "width", "uriFragment", "styles", "parameters", "target", "immediate", "caption", "readOnly", "description", "primaryStyleName", "registeredEventListeners", "resources", "errorMessage", "id", "enabled", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"height", "immediate", "primaryStyleName", "description", "registeredEventListeners", "readOnly", "caption", "width", "id", "enabled", "errorMessage", "styles", "resources", });
            store.setProperties(java.util.Date.class, new String[] {"seconds", "month", "date", "year", "minutes", "hours", "time", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"caption", "id", "propertyReadOnly", "readOnly", "registeredEventListeners", "primaryStyleName", "tabIndex", "immediate", "enabled", "modified", "errorMessage", "resources", "styles", "hideErrors", "width", "required", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"id", "hideOnMouseOut", "errorMessage", "immediate", "caption", "registeredEventListeners", "primaryStyleName", "description", "height", "enabled", "readOnly", "styles", "width", "resources", "html", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LoadingIndicatorConfigurationState.class, new String[] {"secondDelay", "thirdDelay", "firstDelay", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"resources", "connectorToCssPosition", "description", "enabled", "primaryStyleName", "styles", "immediate", "width", "id", "registeredEventListeners", "errorMessage", "readOnly", "height", "caption", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"modified", "tabIndex", "enabled", "propertyReadOnly", "immediate", "resources", "readOnly", "description", "required", "id", "hideErrors", "height", "width", "caption", "styles", "registeredEventListeners", "errorMessage", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"required", "primaryStyleName", "resources", "modified", "enabled", "caption", "propertyReadOnly", "height", "styles", "registeredEventListeners", "tabIndex", "width", "immediate", "readOnly", "errorMessage", "hideErrors", "description", "id", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"width", "resources", "registeredEventListeners", "id", "caption", "height", "immediate", "modified", "enabled", "hideErrors", "propertyReadOnly", "rangeEnd", "primaryStyleName", "description", "readOnly", "rangeStart", "tabIndex", "errorMessage", "required", "styles", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"caption", "description", "errorMessage", "htmlContentAllowed", "muted", "id", "registeredEventListeners", "primaryStyleName", "sources", "sourceTypes", "readOnly", "autoplay", "height", "immediate", "showControls", "width", "styles", "enabled", "resources", "altText", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"errorMessage", "immediate", "styles", "caption", "contentMode", "height", "width", "primaryStyleName", "readOnly", "registeredEventListeners", "enabled", "text", "description", "id", "resources", });
            ...
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"readOnly", "tabIndex", "description", "immediate", "required", "height", "caption", "id", "modified", "primaryStyleName", "hideErrors", "errorMessage", "registeredEventListeners", "enabled", "width", "styles", "resources", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"spacing", "immediate", "enabled", "height", "childData", "marginsBitmask", "styles", "primaryStyleName", "caption", "errorMessage", "resources", "width", "readOnly", "registeredEventListeners", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"callbackNames", "readOnly", "primaryStyleName", "height", "caption", "errorMessage", "rpcInterfaces", "enabled", "width", "resources", "description", "styles", "immediate", "id", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"registeredEventListeners", "description", "caption", "immediate", "id", "resources", "primaryStyleName", "readOnly", "errorMessage", "height", "tabIndex", "width", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"height", "immediate", "registeredEventListeners", "enabled", "errorMessage", "modified", "id", "required", "width", "primaryStyleName", "tabIndex", "caption", "readOnly", "description", "styles", "resources", "propertyReadOnly", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"rows", "enabled", "inputPrompt", "registeredEventListeners", "hideErrors", "styles", "text", "height", "propertyReadOnly", "modified", "caption", "primaryStyleName", "immediate", "resources", "required", "id", "readOnly", "columns", "tabIndex", "maxLength", "description", "width", "wordwrap", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"immediate", "primaryStyleName", "alternateText", "registeredEventListeners", "id", "caption", "resources", "errorMessage", "readOnly", "description", "width", "height", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"styles", "loadingIndicatorConfiguration", "pollInterval", "localeServiceState", "primaryStyleName", "caption", "overlayContainerLabel", "readOnly", "enabled", "pageState", "immediate", "errorMessage", "registeredEventListeners", "description", "id", "tooltipConfiguration", "tabIndex", "width", "pushConfiguration", "resources", "height", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"resources", "id", "description", "registeredEventListeners", "caption", "primaryStyleName", "height", "errorMessage", "width", "styles", "enabled", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"registeredEventListeners", "enabled", "firstChild", "primaryStyleName", "splitterState", "immediate", "description", "readOnly", "id", "height", "resources", "styles", "width", "caption", "errorMessage", "secondChild", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"tabIndex", "resources", "id", "propertyReadOnly", "width", "enabled", "modified", "hideErrors", "description", "immediate", "errorMessage", "registeredEventListeners", "required", "caption", "height", "styles", "primaryStyleName", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"width", "immediate", "registeredEventListeners", "styles", "height", "resources", "id", "enabled", "showControls", "readOnly", "sources", "altText", "primaryStyleName", "sourceTypes", "errorMessage", "caption", "autoplay", "description", "htmlContentAllowed", "muted", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"description", "height", "enabled", "caption", "registeredEventListeners", "readOnly", "primaryStyleName", "tabIndex", "resources", "modified", "propertyReadOnly", "immediate", "styles", "required", "errorMessage", "checked", "id", "hideErrors", "width", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"primaryStyleName", "registeredEventListeners", "width", "columns", "resources", "id", "enabled", "caption", "styles", "rows", "errorMessage", "spacing", "marginsBitmask", "height", "readOnly", "childData", "immediate", "description", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"modified", "tabIndex", "width", "styles", "immediate", "required", "primaryStyleName", "propertyReadOnly", "height", "readOnly", "caption", "text", "description", "columns", "inputPrompt", "resources", "registeredEventListeners", "enabled", "hideErrors", "id", "maxLength", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"modified", "required", "description", "id", "tabIndex", "height", "styles", "primaryStyleName", "resources", "width", "enabled", "readOnly", "propertyReadOnly", "errorMessage", "caption", "registeredEventListeners", "hideErrors", "immediate", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"altKey", "shiftKey", "button", "relativeY", "ctrlKey", "relativeX", "metaKey", "clientY", "type", "clientX", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"registeredEventListeners", "enabled", "names", "resources", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"caption", "propertyReadOnly", "hideErrors", "width", "resources", "rangeStart", "enabled", "modified", "height", "readOnly", "rangeEnd", "descriptionForAssistiveDevices", "tabIndex", "registeredEventListeners", "errorMessage", "immediate", "id", "textFieldEnabled", "required", "styles", "primaryStyleName", "description", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"errorMessage", "registeredEventListeners", "width", "resources", "height", "description", "readOnly", "immediate", "firstChild", "secondChild", "primaryStyleName", "splitterState", "styles", "caption", "id", "enabled", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"errorMessage", "height", "styles", "id", "registeredEventListeners", "readOnly", "childData", "spacing", "resources", "primaryStyleName", "width", "description", "enabled", "marginsBitmask", "immediate", "caption", });
            ...
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"primaryStyleName", "positionY", "registeredEventListeners", "positionX", "resizeLazy", "caption", "resources", "resizable", "height", "centered", "immediate", "modal", "windowMode", "tabIndex", "description", "scrollTop", "readOnly", "scrollLeft", "width", "id", "styles", "enabled", "errorMessage", "draggable", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"firstDayOfWeek", "monthNames", "hourMinuteDelimiter", "twelveHourClock", "dateFormat", "am", "name", "shortDayNames", "pm", "dayNames", "shortMonthNames", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"minPosition", "position", "positionUnit", "minPositionUnit", "positionReversed", "maxPosition", "locked", "maxPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"state", "errorMessage", "propertyReadOnly", "styles", "description", "readOnly", "tabIndex", "registeredEventListeners", "primaryStyleName", "caption", "id", "resources", "modified", "hideErrors", "height", "immediate", "indeterminate", "width", "enabled", "pollingInterval", "required", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"codebase", "width", "enabled", "caption", "standby", "description", "errorMessage", "codetype", "readOnly", "archive", "id", "alternateText", "registeredEventListeners", "resources", "embedParams", "immediate", "classId", "primaryStyleName", "styles", "height", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"resources", "description", "immediate", "height", "styles", "enabled", "readOnly", "width", "registeredEventListeners", "errorMessage", "id", "caption", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"caption", "enabled", "tabIndex", "registeredEventListeners", "styles", "immediate", "errorMessage", "propertyReadOnly", "hideErrors", "footer", "height", "width", "readOnly", "required", "primaryStyleName", "layout", "resources", "description", "modified", "id", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"description", "enabled", "height", "width", "immediate", "resources", "registeredEventListeners", "alternateText", "primaryStyleName", "caption", "styles", "id", "errorMessage", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"immediate", "errorMessage", "styles", "enabled", "caption", "id", "readOnly", "scrollTop", "scrollLeft", "height", "width", "description", "resources", "registeredEventListeners", "tabIndex", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"iconAltText", "primaryStyleName", "errorMessage", "id", "resources", "disableOnClick", "width", "immediate", "readOnly", "clickShortcutKeyCode", "enabled", "styles", "description", "registeredEventListeners", "tabIndex", "height", "htmlContentAllowed", "caption", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"column2", "column1", "row1", "row2", "alignment", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"timeTo", "dateFrom", "caption", "index", "timeFrom", "dateTo", "styleName", "allDay", "description", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"iconKey", "endDate", "actionKey", "caption", "startDate", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Day.class, new String[] {"date", "dayOfWeek", "localizedDateFormat", "week", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"days", "format24H", "lastVisibleDayOfWeek", "firstVisibleDayOfWeek", "width", "monthNames", "height", "readOnly", "scroll", "firstDayOfWeek", "errorMessage", "events", "dayNames", "registeredEventListeners", "now", "firstHourOfDay", "immediate", "description", "actions", "enabled", "lastHourOfDay", "caption", "styles", "resources", "primaryStyleName", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"description", "cursorX", "cursorY", "id", "resources", "registeredEventListeners", "errorMessage", "styles", "primaryStyleName", "height", "immediate", "enabled", "caption", "bgColor", "width", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"width", "primaryStyleName", "showDefaultCaption", "id", "enabled", "height", "caption", "styles", "resources", "readOnly", "htmlContentAllowed", "errorMessage", "immediate", "popupVisible", "color", "description", "registeredEventListeners", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"changedY", "rowCount", "changedX", "errorMessage", "id", "readOnly", "immediate", "caption", "changedColor", "resources", "description", "height", "columnCount", "width", "registeredEventListeners", "styles", "primaryStyleName", "enabled", });
